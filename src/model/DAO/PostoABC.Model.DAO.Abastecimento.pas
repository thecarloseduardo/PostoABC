...
begin
  ...
  try
    Self.FConnection
      ...
      .ClearSQL
      .SQL('SELECT')
      .SQL('	A.DATA_ABASTECIMENTO,')
      .SQL('  B.IDENTIFICACAO_BOMBA,')
      .SQL('  T.NUMERO_TANQUE,')
      .SQL('  A.VALOR_LITRO,')
      .SQL('  A.QUANTIDADE_LITROS,')
      .SQL('  A.VALOR_ABASTECIMENTO,')
      .SQL('  A.IMPOSTO,')
      .SQL('  CAST(SUM(A.VALOR_ABASTECIMENTO - (A.VALOR_ABASTECIMENTO * A.IMPOSTO)) AS FLOAT) AS TOTAL')
      .SQL('FROM')
      ...
      .SQL('  A.VALOR_ABASTECIMENTO,')
      .SQL('  A.IMPOSTO')
      .SQL('ORDER BY DATA_ABASTECIMENTO')
