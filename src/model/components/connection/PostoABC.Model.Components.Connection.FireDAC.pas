...
//  FDConnection.Params.Database := ExtractFilePath(Application.ExeName) + '\database\PostoABC.db3';
  FDConnection.Params.Database := ExtractFilePath(Application.ExeName) + '\database\PostoABC.fdb';
